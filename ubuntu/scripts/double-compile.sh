...
cp -pr $source_code_folder/build/linux-x86_64-server-release/images/jdk $output_folder/stage1_$grand_parent_compiler_version
...
cp -pr $source_code_folder/build/linux-x86_64-server-release/images/jdk $output_folder/stage2_$grand_parent_compiler_version
